...
# Everytime you launch a pod, cd to gym_duckietown and run: export PYTHONPATH="${PYTHONPATH}:`pwd`"

# Command to run python files: xvfb-run -s "-screen 0 1024x768x24" python3 .... 
